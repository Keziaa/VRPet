...
// From: https://forum.unity.com/threads/mirror-reflections-in-vr.416728/#post-3691759
...
public class MirrorReflection : MonoBehaviour
{
    ...
    private void CreateMirrorObjects(Camera currentCamera, Camera.StereoscopicEye eye, out Camera reflectionCamera, ref RenderTexture reflectionTexture)
    {
        ...
        {
            GameObject go = new GameObject("Mirror " + GetInstanceID() + " Reflection Camera id "  + " for " + currentCamera.GetInstanceID(), typeof(Camera), typeof(Skybox));
